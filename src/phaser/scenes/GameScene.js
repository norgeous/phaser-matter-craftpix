...
export default class GameScene extends Phaser.Scene {
  ...
  create () {
    ...
    this.characterGroup.create(500,1100, { type: 'crow' });
    this.characterGroup.create(600,1100, { type: 'zombie' });
    this.characterGroup.create(400,1100, { type: 'orangetabby' });
    this.characterGroup.create(300,1100, { type: 'dobermann' });
